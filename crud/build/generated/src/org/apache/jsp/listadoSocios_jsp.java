...
public final class listadoSocios_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t");
		...
		while (listado.next()) {
			out.println(listado.getString("marca") + " " + listado.getString ("modelo") +  " " + listado.getString ("modelo")<br>");
    }
